...
const DashboardPage: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg">
      {" "}
      {/* Using lg for potentially wider dashboard */}
      <Box sx={{ my: 4 }}>
        {" "}
        ...
        <Grid container spacing={3}>
          {" "}
          {/* Use Grid container to layout cards */}
            ...
            >
              <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  View your connected account details, including name and email
                  address.
                </Typography>
              </CardContent>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            ...
            >
              <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Manage your preferences, security options, and other account
                  settings.
                </Typography>
              </CardContent>
              <CardActions sx={{ px: 2, pb: 2 }}>
