...
const App: React.FC = () => {
  ...
  const drawerContent = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      {" "}
      {/* Close drawer if clicking inside Box but outside Button */}
      <Toolbar />{" "}
      {/* Optional: Spacer to clear AppBar height, less critical for temporary */}
      <Divider />
      <List>
        {navItems.map((item) => (
  ...
  return (
    ...
    <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <AppBar component="nav" position="sticky">
        {" "}
        {/* Use component="nav" for semantics */}
        <Toolbar>
